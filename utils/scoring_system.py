    ...
    try:
        ...
        if pred_outcome == actual_outcome:
            ...
            if pred_diff == actual_diff:
                return 2
            # Угадал только исход (но разницу не угадал)
            else:
                return 1
...
📝 **Примеры:**
- Реальный счет: 2-1
  • Ставка 2-1 = 4 очка (точный счет)
  • Ставка 3-2 = 2 очка (исход + разница: +1)
  • Ставка 1-0 = 2 очка (исход + разница: +1) 
  • Ставка 2-0 = 1 очко (только исход: победа хозяев)
  • Ставка 2-2 = 0 очков
...
- Реальный счет: 0-2
  • Ставка 0-2 = 4 очка
  • Ставка 1-3 = 2 очка (исход + разница: -2)
  • Ставка 0-1 = 1 очко (только исход: победа гостей)
"""